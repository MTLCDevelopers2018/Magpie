...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MGPC");
    case mBTC: return QString("mMGPC");
    case uBTC: return QString::fromUtf8("μMGPC");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("MGPC");
    case mBTC: return QString("Milli-MGPC (1 / 1,000)");
    case uBTC: return QString("Micro-MGPC (1 / 1,000,000)");
    default: return QString("???");
    }
}
